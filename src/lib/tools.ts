...
export interface ToolDef {
  ...
  category: "text" | "dev" | "converters" | "generators" | "productivity" | "media" | "calculators" | "others";
  howToUse: string[];
  howToUseEn: string[];
...
export const tools: ToolDef[] = [
  ...
  {
    id: "steadfast", title: "Steadfast Booking", description: "Courier Easy booking tool", icon: Package, category: "productivity", version: "v1.98",
    requiresApi: { name: "Steadfast API", key: "steadfast_api_key", description: "Steadfast courier API key" },
    howToUse: ["প্রথমে Steadfast API Key ও Secret Key সেট করুন।", "Single মোডে: কাস্টমারের মেসেজ পেস্ট করুন → প্রসেস → বুকিং কনফার্ম।", "Bulk মোডে: একাধিক অর্ডার --- দিয়ে আলাদা করে দিন → একসাথে বুকিং।", "AI Bulk মোডে: মেসেঞ্জারের অগোছালো মেসেজ পেস্ট করুন → AI তথ্য বের করবে।", "AI মোডের জন্য Google Gemini API Key প্রয়োজন হবে (ফ্রি)।", "single এবং bulk মোডে আপনার অর্ডারের মেসেজগুলো এই সিরিয়ালে লিখুন-"],
    howToUseEn: ["১ম লাইন: কাস্টমারের নাম।", "২য় লাইন: বিস্তারিত ঠিকানা (থানা ও জেলাসহ)।", "৩য় লাইন: ফোন নম্বর।", "৪র্থ লাইন: COD টাকার পরিমাণ (যেমন: 500)"]
  },
  {
    id: "bulk-sms", title: "Bulk SMS Assistant", description: "Your Personal Bulk SMS Assistant", icon: Mail, category: "others",
    howToUse: ["নিচের বাটনে ক্লিক করুন। এসএমএস এসিস্ট্যান্ট সাইট ওপেন হবে", "সেখানে একাগন্ট খুলুন এবং লগইন করুন।", "লগইনের পরে আপনার ফোন কানেক্ট করে আপনার ফোনকে বাল্ক এসএমএস সার্ভার হিসেবে ব্যবহার করুন।", "নোট: এক্ষেত্রে জিপি সিম না ব্যবহার করার পরামর্শ রইলো। জিপিতে সমস্যা হয়।"],
    howToUseEn: ["Click the button below to open Bulk SMS Assistant.", "This will redirect you to an external site.", "Open an Account and Connect your phone", "You can use your phone as bulk SMS server now."]
  },
  {
    id: "live-tv", title: "Live Islamic TV", description: "Watch Live Islamic TV channels", icon: Radio, category: "others",
